...
[Description("Represents a list of Proposed Change Orders (PCOs) in Accubid Anywhere")]
public class PCOsDataObject
{
    [JsonPropertyName("id")]
    ...
    public Dictionary<string, object>? ReferenceFields { get; init; }
}
