namespace Connector;
using Connector.ChangeOrder.v1;
using Connector.Client;
using Connector.Closeout.v1;
using Connector.Connections;
using Connector.Database.v1;
using Connector.Estimate.v1;
using Connector.Project.v1;
using ESR.Hosting;
...
public class ConnectorRegistration : IConnectorRegistration<ConnectorRegistrationConfig>, IConfigureConnectorApiClient
{
    ...
    public void ConfigureServices(IServiceCollection serviceCollection, IHostContext hostContext)
    {
        ...
        serviceCollection.AddTransient<Connector.Client.RetryPolicyHandler>();
    }
    ...
    {
        serviceCollection.AddSingleton<IConnectorServiceDefinition, DatabaseV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, DatabaseV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, EstimateV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, EstimateV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ProjectV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ProjectV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, CloseoutV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, CloseoutV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ChangeOrderV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ChangeOrderV1CacheWriterServiceDefinition>();
    }
